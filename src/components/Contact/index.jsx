...
const Contact = () => {
    ...
    return (
        <div id="contact" className="contact">
            <Typography
                align="center"
                sx={[typographyStyles, { fontFamily: "sans-serif", opacity: "1" }]}
                variant="h5"
            >
                Get<b className="bold"> In Touch</b>
            </Typography>
            ...
            >
                <Grid container spacing={2} columns={10}>
                    <Grid item md={5} xs={10} sx={{ justifyContent: "center" }}>
                        <Typography sx={[typographyStyles, { opacity: "1" }]} variant="h5">
                            Send us Message
                        </Typography>
                        <Box
                            component="form"
                        ...
                        >
                            ...
                            <Button type="submit" sx={btnStyles}>
                                Send Message
                            </Button>
                    ...
                    <Grid item md={4} xs={10}>
                        ...
                        <ListItem style={contactDetails}>
                            ...
                            <Typography sx={typographyStyles} variant="subtitle2">
